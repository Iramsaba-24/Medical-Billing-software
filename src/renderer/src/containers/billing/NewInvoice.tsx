...
const NewInvoice = () => {
  ...
  const onSubmit = (data: FormData) => {
    ...
    // ✅ FIXED: GST calculate karke grandTotal nikalo
 ...
 const newInvoice = {
  ...
  totalPrice: grandTotal,
    ...
    // ✅ FIXED: grandTotal pass ho raha hai PaymentMethod ko

    navigate(URL_PATH.PaymentMethod, {
 
      state: { totalFromInvoice: grandTotal },
