...
const MediPoints: React.FC = () => {
  ...
  useEffect(() => {
    const validUsed = usedNow > earned ? earned : usedNow < 0 ? 0 : usedNow;
    ...
    methods.setValue("discountedAmount", finalAmount.toFixed());
            ...
            >
              ...
              <Box sx={{ flex: 1 }}>
                ...
                <Box mb={2}>
                  ...
                  <TextInputField name="discountedAmount" label="" />
                </Box>
              </Box>
            </Box>
