...
// //     try {
// //       const res = await getDistributors();  // API मधून डेटा
// //       setDistributors(res);
// //     } catch (err) {
...
//   const fetchData = async () => {
//     try {
//       const res = await getDistributors(); // API response

//       const formattedData: Distributor[] = res.map((item) => ({
//         id: item.distributorId.toString(),   // convert backend - frontend id
