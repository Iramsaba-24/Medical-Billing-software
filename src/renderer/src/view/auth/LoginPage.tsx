    ...
    try {
      ...
      if (axios.isAxiosError(error)) {
        ...
        if (typeof errorMessage === 'string') {
          ...
          showToast("error", "Subscription not active. Please activate your plan.");
        } else {
...
//                 validate: (value: string) => {
//                   const emailRegex = /^[a-z0-9]+@[a-z0-9]+\.[a-z]{2,}$/i;
//                   const usernameRegex = /^[a-zA-Z0-9_.@]{3,20}$/; // Allow letters, numbers, underscores, dots,  with length between 3 and 20
//                     if (value.includes("@")) {
//                     if (/[A-Z]/.test(value))  return "Email must be in lowercase letters only";
//                   if (!/[@ ]/.test(value)) return "Add special character (@)";
//                     if (!/[. ]/.test(value)) return "Add special character (.)";
