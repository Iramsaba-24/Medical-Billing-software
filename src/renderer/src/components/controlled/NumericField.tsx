...
//   customValidate?: (value: string) => true | string;
//   sx?: SxProps<Theme>;
// };
...
//   if (!value) {
//     if (required) {
//       return translations.numericField.requiredError(label);
//     }
...
//       return translations.numericField.invalidNumber(label);
//     }
//   } else {
//     if (!numericRegex.test(value)) {
//       return translations.numericField.onlyNumbers(label);
//     }
//   }
...
//   // default min/max validation
//   if (numericValue < min) {
//     return translations.numericField.minValue(label, min);
//   }

//   if (numericValue > max) {
//     return translations.numericField.maxValue(label, max);
//   }
...
//     if (decimals.length > decimalDigits) {
//       return translations.numericField.decimalLimit(
//         label,
//         decimalDigits,
//       );
//     }
